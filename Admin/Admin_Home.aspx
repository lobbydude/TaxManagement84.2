<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/AdminHome.master" AutoEventWireup="true"  CodeFile="Admin_Home.aspx.cs" Inherits="Admin_Admin_Home" %>
...
<asp:Content ID="Content1" runat="server" 
    ...
    <script language="javascript" type="text/javascript">
     ...
     <asp:UpdatePanel ID="UpdateDashboard" runat="server" UpdateMode="Always"><%--<Triggers><asp:PostBackTrigger ControlID="btn_Export" /></Triggers>--%><ContentTemplate>
       ...
       <%-- <tr>
         ...
         <tr>
            <td>
               <div id="DivView" runat="server"  align="center" style="height:100%; width:100%;" class="DivContentBody">
                  


                               
                 <table align="center" style="width:98%; height:400px;" >
                                            ...
                                            <table style="width:100%">
                                                <tr>
                                                    <td style="width:350px;">
                                                        <asp:Button ID="btn_Add_New" runat="server" 
                                                              CssClass="WebButton" 
                                                            Text="Add New Order" onclick="btn_Add_New_Click" TabIndex="1"  />
                                                        <asp:Button ID="btn_Import" runat="server" 
                                                              CssClass="WebButton" 
                                                            Text="Import" onclick="btn_Import_Click" TabIndex="2" />
                                                        <asp:Button ID="btn_refresh" runat="server" CssClass="WebButton" 
                                                            onclick="btn_refresh_Click" Text="Refresh" TabIndex="3" />
                                                        <%--<asp:Button ID="btn_Export" Visible="false" runat="server" 
                                                              CssClass="WebButton" 
                        ...
                        <asp:Label ID="label1" runat="server" Text="Search Orders" CssClass="Label" Width="90"></asp:Label>
                            ...
                            <td  align="center" >
                                ...
                                <div class="imgMailFaxQue">
                                    ...
                                    <asp:Label ID="label3" runat="server" Text="Mail/Fax Queue" CssClass="Label" Width="95"></asp:Label>
                                    </a>
                                    </td></tr>
                                </table>
                                ...
                                <div class="imgQcQue"></div>
                                    ...
                                    <asp:Label ID="label4" runat="server" Text="Quality Check Queue" CssClass="Label" Width="115"></asp:Label>
                                    </a>
                                    </td></tr>
                                </table>
                                  </td>
                           <td  align="center"  valign="top">
                              ...
                              <table align="center" style="width:100%">
                                ...
                                <div id="divwebalocate" runat="server" class="imgWebCallAllocate">
                                   ...
                                   <asp:LinkButton ID="lnk_webcall_allocation1" runat="server" TabIndex="13" 
                                    ...
                                    <asp:Label ID="label7" runat="server" Text="Web/Call Order Allocation" CssClass="Label" Width="145"></asp:Label>
                                    </asp:LinkButton> 
                                    </td></tr>
                                </table>
                            ...
                            <td align="center"  valign="top">
                                ...
                                <div id="divMailalocate" runat="server" class="imgMailFaxAllocate">
                                    ...
                                    <asp:Label ID="label8" runat="server" Text="Mail/Fax Order Allocation" 
                            ...
                            <td  align="center" >
                                 ...
                                 <div id="divQCalocate" runat="server" class="imgQualityAllocate">
                                    ...
                                    <asp:Label ID="label9" runat="server" Text="Quality Check Order Allocation" 
                                ...
                                <div id="DiExport" runat="server" class="imgExport">
                                    ...
                                    <asp:Label ID="label10" runat="server" Text="Order Export" CssClass="Label" 
                                            Width="85px"></asp:Label>
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <table style="width: 51%" align="left">
                                                            <tr>
                                                                <td style="width:75px;">
                                                                ...
                                                                <td>
                                                                    <asp:Button ID="btn_Submit" runat="server" CssClass="GridButton" style="text-align:center"
                                                                         onclick="btn_Submit_Click" Text="Search" Width="67px" Visible="False" 
                                                                        TabIndex="22" />
                                                                </td>
                                                            </tr>
                                                        </table>
