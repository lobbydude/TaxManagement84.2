<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/AdminHome.master" AutoEventWireup="true" CodeFile="Create_Order_Type.aspx.cs" Inherits="Admin_Create_Order_Type" %>
...
<asp:Content ID="Content1" runat="server" 
    ...
    <asp:UpdatePanel ID="upnews" runat="server" UpdateMode="Always"><ContentTemplate>
      <table style="width: 100%">
        <tr>
            <td>
               <div id="content">
                <span class="WebFont1">Order Type</span>
	...
	<li class="shadow"></li>
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        <td  align="left" style="width: 356px; padding-left: 200px;">
                                            <asp:Label ID="Label1" runat="server" CssClass="Label"  Font-Size="14px"   Text="Order Type No:"></asp:Label>
                                         </td>
                                    ...
                                    <tr>
                                        <td style="width: 356px; padding-left: 200px;" >
                                            <asp:Label ID="Label4" runat="server" CssClass="Label"  Font-Size="14px"   Text="Order Type:"></asp:Label>
                                        </td>
                                       
                                        <td >
                                            <asp:TextBox ID="txt_Order_Type" runat="server" CssClass="textbox" 
                                                ontextchanged="txt_Order_Type_TextChanged" TabIndex="3" Width="200px"></asp:TextBox>
                                        </td>
...
&nbsp;</td>
                   ...
                   <table style="width: 100%; height:500px;">
                      ...
                      CssClass="WebButton"    Text="Add New Order Type" TabIndex="1" 
                                                                 /> 
                       ...
                       <tr>
                           <td valign="top" align="center">
                                   <asp:GridView ID="grd_Order_Type_details" CssClass="name" runat="server" 
                            AutoGenerateColumns="False" DataKeyNames="Order_Type_ID" 
                          OnRowDeleting="grd_Order_Type_details_RowDeleting"
                                    onselectedindexchanged="grd_Order_Type_details_SelectedIndexChanged" 
                                       CellPadding="4"  ForeColor="#333333" 
                                       GridLines="None" Width="80%">
                                       
                            <Columns>
                                <asp:BoundField  HeaderStyle-CssClass="head-label"   DataField="Order_Type_ID"  HeaderStyle-HorizontalAlign="Center" 
...
<ItemStyle CssClass="grid-item"   HorizontalAlign="Center" Width="30px"></ItemStyle>
                                ...
                                <asp:BoundField  HeaderStyle-CssClass="head-label"   DataField="Order_Type" HeaderStyle-HorizontalAlign="Center" 
                                     ItemStyle-HorizontalAlign="Center" HeaderText="Order Type" >
<HeaderStyle CssClass="head_style"  Height="30px"   HorizontalAlign="Center" ></HeaderStyle>
