<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/AdminHome.master" AutoEventWireup="true" CodeFile="Order_Create.aspx.cs" Inherits="Admin_Order_Create"   %>
...
<script type="text/javascript" src="AdminJs/expandJScript.js"></script>
      ...
      <asp:UpdatePanel ID="upnews" runat="server" UpdateMode="Always"><Triggers><asp:PostBackTrigger ControlID="btn_Export" /></Triggers><ContentTemplate>
                   ...
                   <table style="width: 100%;">
                             ...
                             <td align="center">
                                 <table style="width: 100%">
                                     <tr>
                                         ...
                                         <td align="right">
                                             <asp:Button ID="btn_Import" runat="server" CssClass="WebHRButton green" 
                                                 TabIndex="26" Text="Import" onclick="btn_Import_Click" />
                                             <asp:Button ID="btn_Export" runat="server" CssClass="WebHRButton green" 
                                                 TabIndex="26" Text="Export" onclick="btn_Export_Click" />
                                             <asp:Button ID="btn_Submit0" runat="server" 
                                                   CssClass="WebButton"    onclick="btn_Submit_Click" 
                                                 TabIndex="26" Text="Add New Order" Width="150px" />
                                         </td>
                                     </tr>
                                 </table>
                             </td>
                       ...
                       <tr>
                           <td align="center" valign="top">
                                   ...
                                   CssClass="name" DataKeyNames="Order_ID" Font-Size="Medium" 
                                     ...
                                     <asp:TemplateField>
                                                            ...
                                                            <HeaderTemplate>
                                                                ...
                                                                <asp:CheckBox ID="chkBxHeader" runat="server" Checked="True" 
                                                                    onclick="javascript:HeaderClick(this);" Visible="false" />
                                                            </HeaderTemplate>
                                                        </asp:TemplateField>
                                       <asp:TemplateField Visible="false">
                                        ...
                                        <asp:TemplateField Visible="false">
                                           <ItemTemplate>
                                               <asp:Label ID="lblorderid" CssClass="Label" runat="server" 
                                       ...
                                       <asp:TemplateField   HeaderText="Order #" SortExpression="Order_Number">
                                          ...
                                          <HeaderTemplate>
                                          Order_Number
                                          <asp:ImageButton ID="btn_order_Filer" runat="server"   ImageUrl="~/images/Gridview/Filter.png" Width="16px" Height="16px"   />
                                          </HeaderTemplate>
                                           <ItemTemplate>
                                               <asp:Button ID="btnordernumber" Width="100px" runat="server" CommandName="Select" CssClass="WebHRButton cyan" 
                                       ...
                                       <asp:TemplateField  HeaderText="Customer" SortExpression="Client_Name">
                                           ...
                                           <ItemTemplate>
                                               <asp:Label ID="lblcustomerName" CssClass="Label" runat="server" Text='<%#Eval("Client_Name") %>'></asp:Label>
                                           </ItemTemplate>
                                           <HeaderStyle HorizontalAlign="Center" />
                                           <ItemStyle HorizontalAlign="Center" Width="100px" />
                                       </asp:TemplateField>
                                       <asp:TemplateField HeaderText="Customer No" SortExpression="Client_Number">
                                           ...
                                           <ItemTemplate>
                                               <asp:Label ID="lblcustomerNumber" CssClass="Label" runat="server" Text='<%#Eval("Client_Number") %>'></asp:Label>
                                           </ItemTemplate>
                                           <HeaderStyle HorizontalAlign="Center" />
                                           <ItemStyle HorizontalAlign="Center" Width="100px" />
                                       </asp:TemplateField>
                                       <asp:TemplateField HeaderText="Sub Process" SortExpression="Sub_ProcessName">
                                           ...
                                           <ItemTemplate>
                                               <asp:Label ID="lblSub_ProcessName" CssClass="Label" runat="server" 
                                       ...
                                       <asp:TemplateField HeaderText="Submited" SortExpression="Date">
                                           ...
                                           <ItemTemplate>
                                               <asp:Label ID="lblSubmited" CssClass="Label" runat="server" Text='<%#Eval("Date") %>'></asp:Label>
                                           </ItemTemplate>
                                           <HeaderStyle HorizontalAlign="Center" />
                                           <ItemStyle HorizontalAlign="Center" Width="100px" />
                                       </asp:TemplateField>
                                       <asp:TemplateField HeaderText="Order Type" SortExpression="Order_Type">
                                           ...
                                           <ItemTemplate>
                                               <asp:Label ID="lblOrderType" CssClass="Label" runat="server" Text='<%#Eval("Order_Type") %>'></asp:Label>
                                           </ItemTemplate>
                                           <HeaderStyle HorizontalAlign="Center" />
                                           <ItemStyle HorizontalAlign="Center" Width="100px" />
                                       </asp:TemplateField>
                                       <asp:TemplateField HeaderText="Status" SortExpression="Order_Status">
                                           ...
                                           <ItemTemplate>
                                               <asp:Label ID="lblstatus" CssClass="Label" runat="server" Text='<%#Eval("Order_Status") %>'></asp:Label>
                                           </ItemTemplate>
                                           <HeaderStyle HorizontalAlign="Center" />
                                           <ItemStyle HorizontalAlign="Center" Width="100px" />
                                       </asp:TemplateField>
                                       ...
                                       <asp:TemplateField HeaderText="Assigned To" SortExpression="Assignto">
                                          <ItemTemplate>
                                            <asp:Label ID="lblAssignto" runat="server" Text='<%# Eval("Assignto")%>' Visible = "false"></asp:Label>
        <asp:DropDownList ID = "ddlAssign"   CssClass="DropDown" Enabled="false" AutoPostBack="true"  onselectedindexchanged="ddlAssign_SelectedIndexChanged"  Width="150px"  runat = "server">
        </asp:DropDownList>
        </ItemTemplate>
                                           <ItemStyle HorizontalAlign="Center" Width="100px" />
                                       </asp:TemplateField>
                                       <asp:TemplateField HeaderText="Documents" SortExpression="Documents">
                                           ...
                                           <ItemTemplate>
                                               <asp:Label ID="lblDocuments" CssClass="Label" runat="server" Text='<%#Eval("Documents") %>'></asp:Label>
                                           </ItemTemplate>
                                           <HeaderStyle HorizontalAlign="Center" />
                                           <ItemStyle HorizontalAlign="Center" Width="100px" />
                                       </asp:TemplateField>
                                        <asp:TemplateField>
                                           ...
                                           <ItemTemplate>
                                              <asp:Button ID="btnEditOrder"   CommandArgument='<%#DataBinder.Eval(Container.DataItem, "Order_ID") %>'  OnCommand="EditOrder_Details"  runat="server"   CssClass="WebButton"    
                                                   Text="Edit" />
                                           </ItemTemplate>
                                           <HeaderStyle HorizontalAlign="Center" />
                                   ...
                                   <HeaderStyle BackColor="White" Font-Bold="True" ForeColor="#3366CC" 
                                       Font-Size="Large" />
                       ...
                       <tr>
                           <td align="center" valign="top">
                           <div id="dikvexport" runat="server">
 ...
 <ajax:CalendarExtender ID="txt_orderserach_Todate_CalendarExtender" runat="server" 
            ...
            runat="server" CancelControlID="btn_Import_Excel_Cancel"  TargetControlID="LinkButtonExcel"
            PopupControlID="DivImportExcel" Drag="true">
        </cc1:ModalPopupExtender>
        <div id="DivImportExcel"  class="popupConfirmation">
              <asp:UpdatePanel ID="UpdatePanelexcel" runat="server" UpdateMode="Always"><ContentTemplate>
                    ...
                    <table align="center" style="width:100%;">
                           <tr class="tableHeader">
                                                       <td>
                                                           ...
                                                           <label class="AdminHeader">Import Record</label>
                                                           </td>
                                                       <td align="right">
                                                           <asp:Button ID="btn_Import_Excel_Cancel" runat="server" 
                                                               CssClass="WebHRButton red" Text="X" 
                                                               onclick="btn_Import_Excel_Cancel_Click" />
                                                       </td>
                                                   </tr>
                        <tr>
                            <td colspan="2">
                        ...
                        <tr>
                            <td colspan="2">
                               ...
                               <table align="center" style="width:100%;">
                                     <tr>
                                         <td>
                                             <asp:Label ID="Label2" runat="server" CssClass="Label" Text="Customer Name"></asp:Label>
                                         </td>
                                         <td>
                                             &nbsp;</td>
                                     </tr>
                                     <tr>
                                         <td>
                                             <asp:Label ID="Label3" runat="server" CssClass="Label" Text="Sub Process"></asp:Label>
                                         </td>
                                         <td>
                                             &nbsp;</td>
                                     </tr>
                                     <tr>
                                         <td>
                                             <asp:Label ID="Label4" runat="server" CssClass="Label" Text="Created Date"></asp:Label>
                                         </td>
                                         <td>
                                     ...
                                     <tr>
                                         <td>
                                             <asp:Label ID="Label10" runat="server" CssClass="Label" Text="Status"></asp:Label>
                                         </td>
                                         <td>
                                             &nbsp;</td>
                                     </tr>
                                     <tr>
                                         <td>
                                             <asp:Label ID="Label18" runat="server" CssClass="Label" Text="Order Type"></asp:Label>
                                         </td>
                                         <td>
                                             &nbsp;</td>
                                     </tr>
                                              ...
                                              <tr>
                                                  ...
                                                  <td  >
                                                      <asp:Label ID="Label12" runat="server" CssClass="Label" 
                                                          Text="Customer Order Number:"></asp:Label>
                                                  </td>
                                                  <td>
