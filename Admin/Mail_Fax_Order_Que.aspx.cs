...
public partial class Admin_Web_Call_Order_Research : System.Web.UI.Page
{
    ...
    protected void Gridview_Bind_Assigned_Orders()
    {
        ...
        {
            htuser.Add("@Trans", "GET_MAIL_SEARCH_ORDERS_USERWISE");
        }
        else if (Operations == "User_Orders")
        {
            htuser.Add("@Trans", "GET_MAIL_SEARCH_ORDERS_EXCLUDE_USERWISE");
    ...
    protected void Gridview_Bind_Pending_Orders()
    {
        ...
        if (Operations == "My_Orders")
        {
            htuser.Add("@Trans", "GET_MAIL_PENDING_ORDERS_USER_WISE");
        }
        else if (Operations == "User_Orders")
        {
            htuser.Add("@Trans", "GET_AMIL_PENDING_ORDERS_EXCLUDE_USER_WISE");
    ...
    protected void Get_Count_Of_Orders()
    {
        ...
        htMyweb.Add("@Trans", "TOT_USER_MAIL_FOR_WORK");
        ...
        htUserWeb.Add("@Trans", "TOT_EXCLUDE_USER_MAIL_FOR_WORK");
