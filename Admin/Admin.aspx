<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/AdminHome.master" AutoEventWireup="true" CodeFile="Admin.aspx.cs" Inherits="AdminHome" %>
...
<div class="tabbable" id="tabs-303912" >
    ...
    <tr><td colspan="4"><asp:Button ID="btn_refresh" runat="server" CssClass="WebButton" 
                                                            onclick="btn_refresh_Click" Text="Refresh" TabIndex="3" /></td></tr>
    </table>
...
<%--     <table align="center" style="width:30%">
                                    <tr>
                                        <td  align="right" style="width:64px;height:64px">
                                         <asp:LinkButton ID="lnk_Completed" TabIndex="16"    runat="server" onclick="lnk_Completed_Click" 
                                                >
                                                
                                                 
                                 <div id="div2" runat="server" class="img_TaskComplete">
                                 </div>
                                 </asp:LinkButton>ww
                                 </td>
                                        <td valign="top" align="left">
                                        <div align="center"  id="div4" runat="server"  class="bubble">
                                        <asp:Label ID="lbl_Complted_Order_Count"  CssClass="Label" runat="server" Font-Bold="True" 
                                                ForeColor="White" ></asp:Label>
                                    ...
                                    <tr>
                                    <td colspan="2" align="center">
                                     <asp:LinkButton ID="lnk_Completed_Order_Allocate" TabIndex="17"    runat="server" onclick="lnk_Completed_Order_Allocate_Click" 
                                            >
                                    <asp:Label ID="label13" runat="server" Text="Completed Orders" Font-Size="13px" 
                                            CssClass="Label" Width="145px"></asp:Label>
                                            </asp:LinkButton>
                                    </td></tr>
 ...
 <tr><td style="width: 328px"><br /><br /></td></tr>
  ...
  <tr >
   ...
   <table style="width: 100%">
          ...
          <div class="col-sm-12" style="width:410px;" >
				<div style="border-color:#D9D9D9;" class="panel panel-default">
					<div class="panel-heading">
						<span  class="panel-title">Line Graph</span>
						
						<span class="panel-options" style="margin-top:-3px;">
							<a href="#" data-rel="collapse" style="font-size:20px">&#9662;</a>
                            <i>&nbsp;</i>
                           </span>
					</div>
                              ...
                              <table style="width:100%">
                                   ...
                                   <tr>
                                       <td colspan="2">
                            <asp:Literal ID="FC_Pie_Chart"  runat="server"></asp:Literal>
          ...
          <td style="width:300px" id="mycompanydet" runat="server">
          <div class="col-sm-12" style="width:410px;" >
				<div style="border-color:#D9D9D9;" class="panel panel-default">
					<div class="panel-heading">
						<span  class="panel-title">Pie Graph</span>
