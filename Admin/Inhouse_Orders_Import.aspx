<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/AdminHome.master" AutoEventWireup="true" CodeFile="Inhouse_Orders_Import.aspx.cs" Inherits="Admin_Orders_Import" %>
                                              ...
                                              <tr>
                                                  <td align="center"  colspan="3">
                                                      <asp:Button ID="btn_Extract" runat="server"   CssClass="WebButton"    
                                                          Text="Extract" onclick="News_Click" Width="120px" TabIndex="3" />
                                                  </td>
                                              </tr>
                                    ...
                                    <tr>
                                         <td align="center" colspan="2">
                                             <asp:Button ID="btn_Duplicate" runat="server"   CssClass="WebButton"    
                                                 Text="Remove Duplicates" onclick="btn_Duplicate_Click" Width="250px" 
                                                 TabIndex="4" />
