<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/AdminHome.master" AutoEventWireup="true" CodeFile="Web_Call_Order_Research.aspx.cs" Inherits="Admin_Web_Call_Order_Research" %>

<asp:Content ID="Content1" runat="server" 
    contentplaceholderid="ContentPlaceHolder1">
    <style id="Show" type="text/css">
    ...
    <asp:UpdatePanel ID="uporder" runat="server" UpdateMode="Always"><ContentTemplate>
        ...
        <tr>
            <td>
                <div id="content">
                <span class="WebFont1">Web/Call Order Research</span>
         ...
         <tr>
            <td>
               <div id="Divcreate" runat="server"  align="center" style="height:100%; width:100%;" class="DivContentBody">
                 ...
                 <table align="center" style="width:90%; height:600px;" >
                                    ...
                                    <tr>
                                        <td   colspan="2" align="center">
                                              ...
                                              <table style="width:25%">
                                                  <tr>
                                                      <td align="center">
                                                          <asp:Button ID="btn_My_Order" style="padding-left:10px;padding-right:10px" 
                                                              runat="server" Height="40"
                                                              CssClass="WebButton" onclick="btn_My_Order_Click" TabIndex="1" />
                                                      </td>
                                                      <td align="center">
                                                          <asp:Button ID="btn_User_Order" runat="server" Height="40" style="padding-left:10px;padding-right:10px"
                                                              CssClass="GridButton" onclick="btn_User_Order_Click" TabIndex="2" />
                                                      </td>
                                                  </tr>
                                              </table>
                                          </td>
                                    ...
                                    <tr>
                                        <td align="left" colspan="2" style="height:400px;" 
                                            valign="top">
                                                 ...
                                                 <Columns>
                                                        <asp:TemplateField HeaderStyle-CssClass="head-label"   HeaderText="id" Visible="false">
                                                            ...
                                                            <ItemTemplate>
                                                                      ...
                                                                      <asp:Button ID="btnPending_ClientOrder_Number" runat="server" CommandName="EditDetails" Width="150px" CssClass="GridButton" Text='<%# Eval("Client_Order_Number") %>' />
                                                            </ItemTemplate>
                                                            <HeaderStyle CssClass="head_style"  Height="30px"    HorizontalAlign="Center"  />
                                                            <ItemStyle CssClass="grid-item"   HorizontalAlign="Center" Width="100px" />
                                                        </asp:TemplateField>
                                            ...
                                            <table style="width: 100%">
                                                <tr>
                                                    ...
                                                    <td  style="width:200px;">
                                                        &nbsp;</td>
                                                    <td align="right">
                                                        <asp:Button ID="btn_View_Histroy" runat="server" 
                                                              CssClass="WebButton"    Text="View Histroy" 
                                                            onclick="btn_Reallocate_Click" Height="40px" TabIndex="3" />
                                                        <asp:Button ID="btn_Refresh" runat="server" 
                                                              CssClass="WebButton"    onclick="btn_Search_Click" 
                                                            Text="Refresh" Height="40px" TabIndex="4" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
