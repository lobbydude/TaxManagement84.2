...
public partial class Admin_Web_Call_Order_Research : System.Web.UI.Page
{
    ...
    protected void Gridview_Bind_Assigned_Orders()
    {
        ...
        {
            htuser.Add("@Trans", "GET_QC_SEARCH_ORDERS_EXCLUDE_USERWISE");
    ...
    protected void Gridview_Bind_Pending_Orders()
    {
        ...
        if (Operations == "My_Orders")
        {
            htuser.Add("@Trans", "GET_QC_PENDING_ORDERS_USER_WISE");
        }
        else if (Operations == "User_Orders")
        {
            htuser.Add("@Trans", "GET_QC_PENDING_ORDERS_EXCLUDE_USER_WISE");
    ...
    protected void Get_Count_Of_Orders()
    {
        ...
        htMyweb.Add("@Trans", "TOT_USER_QC_FOR_WORK");
        ...
        htUserWeb.Add("@Trans", "TOT_EXCLUDE_USER_QC_FOR_WORK");
    ...
    {
        if (e.CommandName == "EditRecordDetails")
        {
            if (User_Role_Id == "1" && ViewState["Operation"].ToString() == "User_Orders")
            {
            ...
            {
                GridViewRow row = (GridViewRow)(((Button)e.CommandSource).NamingContainer);
                Label lbl_Order_ID = (Label)row.FindControl("lblPendingOrder_id");
    ...
    protected void grd_Assigned_Orders_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            Label lbl_Btn = (Label)e.Row.FindControl("lblProduct_TypeOrder_Location");
