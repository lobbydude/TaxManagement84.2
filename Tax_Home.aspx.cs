...
public partial class Tax_Home : System.Web.UI.Page
{
    ...
    protected void btn_refresh_Click(object sender, EventArgs e)
    {
        ...
        else if (User_Role_Id == "1")
        {
            ...
            Response.Redirect("~/Tax_Home.aspx");
        }
    ...
    private DataTable LoadGraphData()
    {
        ...
        Hashtable htdash = new Hashtable();
        DataTable dtdash = new DataTable();

        htdash.Add("@Trans", "SELECT");
        dtdash = dataaccess.ExecuteSP("Sp_Tax_Dashbord", htdash);
    ...
    {
        string strCaption = "Tax Oredrs Dashboard";
        string strSubCaption = "";
        string xAxis = "Order Status";
        string yAxis = "No Of Orders";
        ...
        //Literal3.Text = FusionCharts.RenderChartHTML(
        //      "FusionCharts/FCF_StackedColumn3D.swf", // Path to chart's SWF
        //      "",                              // Leave blank when using Data String method
        //      strXML,                          // xmlStr contains the chart data
        //      "mygraph1",                      // Unique chart ID
        //      GraphWidth, GraphHeight,                   // Width & Height of chart
