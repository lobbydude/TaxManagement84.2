<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Tax_Admin_Home.aspx.cs" Inherits="Tax_Home" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <link href="AdminStyle/datatable.css" rel="stylesheet" type="text/css" />
  ...
  <body style="background: url(http://images.webhr.co/Background.png);" >
      ...
      <style type="text/css">
          ...
          .WebHRMenu 
          {
            width:100%;
            height:41px;   
            background-image: linear-gradient(to bottom, #4976e9, #2a56c6) !important;
      ...
      <script type="text/javascript">
        $(function () {
            $.ajax({
                ...
                url: 'Tax_Admin_Home.aspx/GetChartData',
                data: '{}',
                success:
                    function (response) {
          ...
          pieHole: 0.4,
            ...
            new google.visualization.BarChart(document.getElementById('chartbar')).
                draw(data, { title: "Show Google Chart in Asp.net" });

            new google.visualization.ColumnChart(document.getElementById('DivColumn')).
                draw(data, { title: "Show Google Chart in Asp.net" });

         

            new google.visualization.ComboChart(document.getElementById('DivCombo')).
                draw(data, { title: "Show Google Chart in Asp.net" });
        ...
        chart.draw(data, options);
          ...
          var chart = new google.charts.Line(document.getElementById('Div_Line'));
          chart.draw(data);
    ...
    <script type="text/javascript">
        $(function () {
            $.ajax({
                ...
                dataType: 'json',
                contentType: 'application/json',
                url: 'Tax_Admin_Home.aspx/GetOrder_Type_Wise_Data',
                data: '{}',
                success:
                    function (response) {
                        drawchart(response.d);
          ...
          pieHole: 0.4,
            ...
            for (var i = 0; i < dataValues.length; i++) {
                data.addRow([dataValues[i].Type, dataValues[i].Total]);
            }
   ...
   <%-- Tax Status Wise--%>
        ...
        $(function Tax_Data () {
            $.ajax({
                ...
                dataType: 'json',
                contentType: 'application/json',
                url: 'Tax_Admin_Home.aspx/Get_Tax_Status_Wise_Data',
                data: '{}',
                success:
                    function (response) {
                        drawTaxchart(response.d);
            ...
            function drawTaxchart(TaxdataValues) {
            var Tax_Status_data = new google.visualization.DataTable();
            Tax_Status_data.addColumn('string', 'Column Name');
            Tax_Status_data.addColumn('number', 'Column Value');
               var Tax_Status_options = {
          title: 'My Daily Activities',
          pieHole: 0.4,
        };
            for (var i = 0; i < TaxdataValues.length; i++) {
                Tax_Status_data.addRow([TaxdataValues[i].Type, TaxdataValues[i].Total]);
            }

            var chart = new google.visualization.PieChart(document.getElementById('Div_donut'));
        chart.draw(Tax_Status_data, Tax_Status_options);
     ...
     <%-- Installment Wise--%>
      <script type="text/javascript">
        $(function Tax_Installment_Data () {
            $.ajax({
                type: 'POST',
                dataType: 'json',
                contentType: 'application/json',
                url: 'Tax_Admin_Home.aspx/Get_Tax_Installment_Wise_Data',
                data: '{}',
                success:
                    function (response) {
                        drawTax_Installmentchart(response.d);
            ...
            function drawTax_Installmentchart(TaxInstdataValues) {
            var Tax_Installment_data = new google.visualization.DataTable();
            Tax_Installment_data.addColumn('string', 'Column Name');
            Tax_Installment_data.addColumn('number', 'Column Value');
             
            for (var i = 0; i < TaxInstdataValues.length; i++) {
                Tax_Installment_data.addRow([TaxInstdataValues[i].Type, TaxInstdataValues[i].Total]);
            }

             new google.visualization.BarChart(document.getElementById('chartbar')).
                draw(Tax_Installment_data, { title: "Show Google Chart in Asp.net" });
                ...
                <div id="menu">
                  <ul class="menu">
                     ...
                     <li id="limasters" runat="server"><a class="linkLabel" href="#" ><span>Masters</span></a>
                        ...
                        <ul style="width:450px; height:140px; background:rgb(238, 238, 238) none repeat scroll 0% 0%;">
                           
                            <li>
                            <div style="margin-top:5px; clear:both;"></div>
                                
                      	    <div class="iemployeetrainings" 
                                    style="float:left; margin-left:10px; width: 10px;">       
                            </div>
                            <div style="width:180px; float:left;"><a class="hrefLabel" href="Admin/Create_Company.aspx">Company</a>
                            </div>
      		...
      		<div class="col-md-12" >
                  ...
                  <div class="tabbable" id="tabs-303912" >
          				<ul class="nav nav-pills" >
            					...
            					<li id="list_itemScore" runat="server" >
                                
            						<a id="li_Score_Board" runat="server" onclick="score()" href="#panel_235561"
      				    ...
      				    <div  class="tab-content"  style="width:100%; float:left; background-color:#fcfafa;">
                      
                       	<div   class="tab-pane active" id="panel_235561" >
                              <div class="container_12">
                                  <div id="divscore"  runat="server"  class="grid_12">
          			                   
                	                  <div class="col-md-12 col-sm-12 col-xs-12" style="padding: 10px 0px;">
          		                               <div class="col-md-4 col-sm-12 col-xs-12">                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                
            				                      <h2 style="font-weight: bold; text-align: center; margin: 0px; background-image: linear-gradient(to bottom, #4976e9, #2a56c6) !important; color: #fff; padding: 10px;">Allocation</h2>

                      				            <div class="col-md-12 col-sm-12 col-xs-12" style="padding: 5px 10px; border: 1px solid #ddd; background-color: #fff;">
                                                  ...
                                                  <div class="card card-stats">
                                                      ...
                                                      <div class="card-content">
                                                            <asp:Label ID="Label7"  CssClass="category" Text="Web / Call Order"  runat="server"></asp:Label>
                                                ...
                                                <div class="col-md-12 col-sm-6 col-xs-12">
                                                  ...
                                                  <div class="card card-stats">
                                                      ...
                                                      <div class="card-content">
                                                             ...
                                                             <asp:Label ID="Label8" runat="server" CssClass="category" Text="Mail / Fax Order" ></asp:Label>
                                                ...
                                                <div class="col-md-4 col-sm-12 col-xs-12">                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
            				                      <h2 style="font-weight: bold; text-align: center; margin: 0px; background-image: linear-gradient(to bottom, #4976e9, #2a56c6) !important; color: #fff; padding: 10px;">Processing</h2>
                                            ...
                                            <asp:LinkButton ID="LinkExport1" runat="server" TabIndex="19" 
                                                ...
                                                <div class="card card-stats">
                                                 ...
                                                 <div class="col-md-4 col-sm-12 col-xs-12">                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  
            				                      <h2 style="font-weight: bold; text-align: center; margin: 0px; background-image: linear-gradient(to bottom, #4976e9, #2a56c6) !important; color: #fff; padding: 10px;">Pending</h2>
      					    ...
      					    <div class="tab-pane" id="panel_505369" >
                          <div class="container_12">
                          <asp:UpdatePanel ID="up_div" runat="server" UpdateMode="Always"><ContentTemplate>
                                   ...
                                   <td  colspan="2" style="text-align:right;">
                                      ...
                                      <tr style=" background: transparent;">
                                        <td align="right" style=" padding-right:10px;">
                                          <asp:RadioButton ID="rdo_CurrentOrder" runat="server" Text="Current Orders" 
                                        ...
                                        <td align="left">
                                          ...
                                          CssClass="radio"  Font-Bold="False" Font-Names="Segoe UI" Font-Size="13px" Width="200px" 
                                      ...
                                      <tr>
          				              ...
          				              <table id="DivView" runat="server" style="width: 100%" >
                                                  ...
                                                  <tr>
                                                      ...
                                                      <td style="width:150px;">
                                                          <asp:DropDownList ID="ddl_Search" runat="server"  TabIndex="3" 
                                                              ...
                                                              <asp:ListItem Value="Received Date">Received Date</asp:ListItem>
                                                  ...
                                                  <tr style=" background: transparent;"><td colspan="7">  <br /></td></tr>
                                                   <tr>
                                                  <td colspan="7">
                                                  ...
                                                  <asp:GridView ID="grd_Orders" runat="server" AllowSorting="True" 
                                                               ...
                                                               CellPadding="4" CssClass="name" GridLines="None" 
                                                                  ...
                                                                  <asp:TemplateField  HeaderStyle-CssClass="head-label" HeaderText="Received Date" >
                                                                      <ItemTemplate>
                                ...
                                <table id="DivCreate"  runat="server" align="center" style="width:90%;" >
                                              ...
                                              <tr>
                                                   <td align="center" colspan="2" valign="middle">
                                                       ...
                                                       <asp:Button ID="Btn_View" runat="server" CssClass="WebButton" 
                                                           onclick="Btn_View_Click" TabIndex="21" Text="View Data" Width="120px" />
                                                   </td>
                                               </tr>
                                                              ...
                                                              <asp:GridView ID="grd_Order_Task" runat="server" 
                                                                  ...
                                                                  <Columns>
                                                                       <asp:TemplateField HeaderStyle-CssClass="head-label" 
                                                                          ...
                                                                          <ItemStyle Height="20px" VerticalAlign="Middle" 
                                                                              Width="30px" />
                                                                      </asp:TemplateField>
                                                                  <asp:TemplateField HeaderStyle-CssClass="head-label" 
                                                              ...
                                                              <asp:GridView ID="grd_Order_Comments" runat="server" AutoGenerateColumns="False" 
                                                                  ...
                                                                  <Columns>
                                                                      ...
                                                                      <asp:TemplateField HeaderStyle-CssClass="head-label" 
                                                                          ...
                                                                          <HeaderStyle CssClass="head_style" Height="30px" HorizontalAlign="Center" />
                                                                          <ItemStyle Height="20px" HorizontalAlign="Left" VerticalAlign="Middle" 
                                                                              Width="30px" />
                                                                      </asp:TemplateField>
                                                                  </Columns>
                                                                  <EmptyDataRowStyle BackColor="#f9f9f9" BorderColor="#D9D9D9" 
                            ...
                            <div class="tab-pane" id="panel_45454">
                                ...
                                <td align="center" style="height: 23px">
                                    <div id="ContentPlaceHolder1_upreport">
                                    <asp:UpdatePanel ID="Up_Chart" runat="server" UpdateMode="Always"><ContentTemplate>
                                        <table style=" width:48%; margin: 0 auto;">
                    <tbody>
                          <tr align="center">
                                        <td>
                                          <asp:RadioButton ID="RadioButton1" runat="server" Text="Tax Certificate" 
                                          CssClass="radio" 
                                          Font-Bold="False" Font-Names="Segoe UI" Font-Size="13px" Width="150px" 
                                          AutoPostBack="True" Checked="True" TabIndex="1" 
                                           />&nbsp;&nbsp;
                                        ...
                                        <td >
                                          <asp:RadioButton ID="RadioButton2"  runat="server" Text="Code Violation" 
                                          CssClass="radio"  Font-Bold="False" Font-Names="Segoe UI" Font-Size="13px" Width="200px" 
                          ...
                          <tr align="center"  style=" background: transparent;">
                                <td >
                                    <asp:Label ID="Label13" runat="server" CssClass="Label" Text="From Date" style=" padding-right: 95px;"></asp:Label>
                                </td>

                                <td >
                                    <asp:Label ID="Label21" runat="server" CssClass="Label" Text="To Date" style=" padding-right: 108px;"></asp:Label>
                                </td>
                          </tr>
                          ...
                          <tr align="center">
                           ...
                           <asp:TextBox ID="txt_Todate" runat="server" CssClass="textbox" TabIndex="1" 
                            ...
                            <td>
                                <input name="ctl00$ContentPlaceHolder1$btn_Submit" value="Submit" id="ContentPlaceHolder1_btn_Submit" tabindex="4" class="WebButton" style="width:120px;" type="submit">
                            </td>
                    </tr>
                          ...
                          <tr>
                              <td align="center" colspan="4">
                                ...
                                <asp:UpdatePanel ID="Up_Chart_New" runat="server" UpdateMode="Always">
                                <ContentTemplate>
                                <div class="col-md-4 col-sm-6 col-xs-12" style="padding:0px 12px; margin-bottom:20px;">
                                    <h2 style="font-weight: bold; text-align: center; margin: 0px; background-image: linear-gradient(to bottom, #4976e9, #2a56c6) !important; color: #fff; padding: 10px;">Order Type</h2>
                                    <div class="col-md-12 col-sm-6 col-xs-12" style="padding:0px; border:1px solid #ddd;">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12" style="padding:0px 12px; margin-bottom:20px;">
                                       <h2 style="font-weight: bold; text-align: center; margin: 0px; background-image: linear-gradient(to bottom, #4976e9, #2a56c6) !important; color: #fff; padding: 10px;">Tax Status</h2>
                                      <div class="col-md-12 col-sm-6 col-xs-12" style="padding:0px; border:1px solid #ddd;">
                                        <div id="Div_donut" style="width: 100%; height: auto;">
                                        </div>
                                      </div>
                                </div>
                                 ...
                                 <div class="col-md-4 col-sm-6 col-xs-12" style="padding:0px 12px; margin-bottom:20px;">
                                    <h2 style="font-weight: bold; text-align: center; margin: 0px; background-image: linear-gradient(to bottom, #4976e9, #2a56c6) !important; color: #fff; padding: 10px;">Tax Status</h2>
                                    <div class="col-md-12 col-sm-6 col-xs-12" style="padding:0px; border:1px solid #ddd;">
                                         <div id="chartbar" style="width: 100%; height: auto;">
                                         </div>
                                    </div>
                               </div>
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12" style="padding:0px 12px; margin-bottom:20px;">
                                        <h2 style="font-weight: bold; text-align: center; margin: 0px; background-image: linear-gradient(to bottom, #4976e9, #2a56c6) !important; color: #fff; padding: 10px;">State</h2>
                                      <div class="col-md-12 col-sm-6 col-xs-12" style="padding:0px; border:1px solid #ddd;">
                                        <div id="DivCombo" style="width: 100%; height: auto;">
                                        </div>
                                      </div>
                                </div>
                                  <div class="col-md-4 col-sm-6 col-xs-12" style="padding:0px 12px; margin-bottom:20px;">
                                    <h2 style="font-weight: bold; text-align: center; margin: 0px; background-image: linear-gradient(to bottom, #4976e9, #2a56c6) !important; color: #fff; padding: 10px;">Installment</h2>
                                    <div class="col-md-12 col-sm-6 col-xs-12" style="padding:0px; border:1px solid #ddd;">
                                         <div id="DivColumn" style="width: 100%; height: auto;">
                                         </div>
                                    </div>
                               </div>
      ...
      <div id="divInbox_ComposeMessage" style="display:none; min-width: 350px; min-height:400px; position: fixed; bottom: 0px; right: 10px; border: 1px solid #b9b9b9; background-color: white;">
      </div> 
      <br /><br />
